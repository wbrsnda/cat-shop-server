...
//   // }
//   const totalCount = await Product.find({"productCategory":productCategory}).count();
//   const products = await Product.find({"productCategory":productCategory}).populate('productCategory').sort({ createdAt: -1 })
//     .limit(per)
//     .skip(per * (page - 1));
//   res.json({
//     totalCount,
